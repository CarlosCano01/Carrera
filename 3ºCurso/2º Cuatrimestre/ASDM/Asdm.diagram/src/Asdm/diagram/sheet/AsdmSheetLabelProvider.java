 ...
 * @generated
 */
public class AsdmSheetLabelProvider extends BaseLabelProvider implements ILabelProvider {
	...
	*/
	private IElementType getElementType(View view) {
		...
		while (view != null) {
			...
			IElementType etype = Asdm.diagram.providers.AsdmElementTypes.getElementType(vid);
			if (etype != null) {
				return etype;
			}
