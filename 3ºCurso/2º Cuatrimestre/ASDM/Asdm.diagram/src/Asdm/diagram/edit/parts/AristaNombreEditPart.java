 ...
 * @generated
 */
public class AristaNombreEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public AristaNombreEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new Asdm.diagram.edit.policies.AsdmTextSelectionEditPolicy());
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = Asdm.diagram.providers.AsdmParserProvider.getParser(
					Asdm.diagram.providers.AsdmElementTypes.Arista_4001, getParserElement(),
					Asdm.diagram.part.AsdmVisualIDRegistry
							.getType(Asdm.diagram.edit.parts.AristaNombreEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null,
					Asdm.diagram.edit.parts.AsdmEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new AristaLabelFigure();
	}

	/**
	 * @generated
	 */
	public class AristaLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public AristaLabelFigure() {
			this.setText("Arista");
		}
