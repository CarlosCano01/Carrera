 ...
 * @generated
 */
public class ActividadActividadSubdiagCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<Asdm.diagram.part.AsdmNodeDescriptor> childDescriptors = Asdm.diagram.part.AsdmDiagramUpdater
				.getActividadActividadSubdiagCompartment_7001SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<Asdm.diagram.part.AsdmNodeDescriptor> childDescriptors = Asdm.diagram.part.AsdmDiagramUpdater
				.getActividadActividadSubdiagCompartment_7001SemanticChildren((View) getHost().getModel());
