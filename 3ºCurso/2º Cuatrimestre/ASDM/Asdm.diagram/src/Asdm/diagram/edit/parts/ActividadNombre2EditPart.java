 ...
 * @generated
 */
public class ActividadNombre2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public ActividadNombre2EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = Asdm.diagram.providers.AsdmParserProvider.getParser(
					Asdm.diagram.providers.AsdmElementTypes.Actividad_3001, getParserElement(),
