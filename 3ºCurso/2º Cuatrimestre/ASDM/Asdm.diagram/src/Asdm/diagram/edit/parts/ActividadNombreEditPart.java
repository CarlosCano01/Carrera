 ...
 * @generated
 */
public class ActividadNombreEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	public IParser getParser() {
		if (parser == null) {
			parser = Asdm.diagram.providers.AsdmParserProvider.getParser(
					Asdm.diagram.providers.AsdmElementTypes.Actividad_2001, getParserElement(),
