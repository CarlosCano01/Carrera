 ...
 * @generated
 */
public class ActividadActividadSubdiagCompartment2CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return Asdm.AsdmPackage.eINSTANCE.getActividad_Subdiag();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<Asdm.diagram.part.AsdmNodeDescriptor> childDescriptors = Asdm.diagram.part.AsdmDiagramUpdater
				.getActividadActividadSubdiagCompartment_7002SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<Asdm.diagram.part.AsdmNodeDescriptor> childDescriptors = Asdm.diagram.part.AsdmDiagramUpdater
				.getActividadActividadSubdiagCompartment_7002SemanticChildren((View) getHost().getModel());
