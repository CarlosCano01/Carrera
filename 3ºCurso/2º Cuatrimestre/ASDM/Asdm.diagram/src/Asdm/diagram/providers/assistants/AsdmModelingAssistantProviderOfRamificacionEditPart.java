 ...
 * @generated
 */
public class AsdmModelingAssistantProviderOfRamificacionEditPart
	...
	*/
	...
	public List<IElementType> getRelTypesOnSource(IAdaptable source) {
		...
		return doGetRelTypesOnSource((Asdm.diagram.edit.parts.RamificacionEditPart) sourceEditPart);
	}

	/**
	* @generated
	*/
	public List<IElementType> doGetRelTypesOnSource(Asdm.diagram.edit.parts.RamificacionEditPart source) {
	...
	*/
	...
	public List<IElementType> getRelTypesOnSourceAndTarget(IAdaptable source, IAdaptable target) {
		...
		return doGetRelTypesOnSourceAndTarget((Asdm.diagram.edit.parts.RamificacionEditPart) sourceEditPart,
				targetEditPart);
	}
	...
	* @generated
	*/
	public List<IElementType> doGetRelTypesOnSourceAndTarget(Asdm.diagram.edit.parts.RamificacionEditPart source,
	...
	*/
	...
	public List<IElementType> getTypesForTarget(IAdaptable source, IElementType relationshipType) {
		IGraphicalEditPart sourceEditPart = (IGraphicalEditPart) source.getAdapter(IGraphicalEditPart.class);
		return doGetTypesForTarget((Asdm.diagram.edit.parts.RamificacionEditPart) sourceEditPart, relationshipType);
	}

	/**
	* @generated
	*/
	public List<IElementType> doGetTypesForTarget(Asdm.diagram.edit.parts.RamificacionEditPart source,
	...
	*/
	...
	public List<IElementType> getRelTypesOnTarget(IAdaptable target) {
		IGraphicalEditPart targetEditPart = (IGraphicalEditPart) target.getAdapter(IGraphicalEditPart.class);
		return doGetRelTypesOnTarget((Asdm.diagram.edit.parts.RamificacionEditPart) targetEditPart);
	}

	/**
	* @generated
	*/
	public List<IElementType> doGetRelTypesOnTarget(Asdm.diagram.edit.parts.RamificacionEditPart target) {
		List<IElementType> types = new ArrayList<IElementType>(1);
		types.add(Asdm.diagram.providers.AsdmElementTypes.Arista_4001);
		return types;
	}
	...
	*/
	...
	public List<IElementType> getTypesForSource(IAdaptable target, IElementType relationshipType) {
		IGraphicalEditPart targetEditPart = (IGraphicalEditPart) target.getAdapter(IGraphicalEditPart.class);
		return doGetTypesForSource((Asdm.diagram.edit.parts.RamificacionEditPart) targetEditPart, relationshipType);
	}

	/**
	* @generated
	*/
	public List<IElementType> doGetTypesForSource(Asdm.diagram.edit.parts.RamificacionEditPart target,
			IElementType relationshipType) {
		List<IElementType> types = new ArrayList<IElementType>();
		if (relationshipType == Asdm.diagram.providers.AsdmElementTypes.Arista_4001) {
			types.add(Asdm.diagram.providers.AsdmElementTypes.Actividad_2001);
