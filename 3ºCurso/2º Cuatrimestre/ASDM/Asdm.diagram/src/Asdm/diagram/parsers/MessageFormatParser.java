...
public class MessageFormatParser extends AbstractAttributeParser {
	...
	*/
	public IParserEditStatus isValidEditString(IAdaptable adapter, String editString) {
		...
		if (values == null) {
			return new ParserEditStatus(Asdm.diagram.part.AsdmDiagramEditorPlugin.ID, IParserEditStatus.UNEDITABLE,
					NLS.bind(Asdm.diagram.part.Messages.MessageFormatParser_InvalidInputError,
