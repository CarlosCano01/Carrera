 ...
 * </p>
 * <ul>
 *   <li>{@link Asdm.impl.ActividadImpl#getNombre <em>Nombre</em>}</li>
 *   <li>{@link Asdm.impl.ActividadImpl#getSubdiag <em>Subdiag</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ActividadImpl extends NodoImpl implements Actividad {
	...
	protected EClass eStaticClass() {
		return AsdmPackage.Literals.ACTIVIDAD;
	}
	...
	public void setNombre(String newNombre) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AsdmPackage.ACTIVIDAD__NOMBRE, oldNombre, nombre));
	}
	...
	public EList<Nodo> getSubdiag() {
		if (subdiag == null) {
			subdiag = new EObjectContainmentEList<Nodo>(Nodo.class, this, AsdmPackage.ACTIVIDAD__SUBDIAG);
		}
		return subdiag;
	}
