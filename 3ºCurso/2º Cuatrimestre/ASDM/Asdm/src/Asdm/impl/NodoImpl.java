 ...
 * </p>
 * <ul>
 *   <li>{@link Asdm.impl.NodoImpl#getSalientes <em>Salientes</em>}</li>
 *   <li>{@link Asdm.impl.NodoImpl#getEntrantes <em>Entrantes</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class NodoImpl extends EObjectImpl implements Nodo {
	...
	protected EClass eStaticClass() {
		return AsdmPackage.Literals.NODO;
	}
	...
	public EList<Arista> getSalientes() {
		if (salientes == null) {
			salientes = new EObjectWithInverseResolvingEList<Arista>(Arista.class, this, AsdmPackage.NODO__SALIENTES, AsdmPackage.ARISTA__ORIGEN);
		}
		return salientes;
	}
	...
	public EList<Arista> getEntrantes() {
		if (entrantes == null) {
			entrantes = new EObjectWithInverseResolvingEList<Arista>(Arista.class, this, AsdmPackage.NODO__ENTRANTES, AsdmPackage.ARISTA__DESTINO);
		}
		return entrantes;
	}
